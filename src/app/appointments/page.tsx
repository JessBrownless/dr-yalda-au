...
export default function AppointmentsPage() {
  return (
    <main className="text-brand-black">
      {/* Hero */}
      <section className="relative -mt-20 min-h-[calc(100dvh_-_var(--announcement-height))] overflow-hidden bg-brand-black text-on-dark-high">
          ...
          <div className="media-teaser__phone" style={{ width: "200px" }}>
            ...
            <div className="relative w-full overflow-hidden" style={{ background: "#1c1c1e", aspectRatio: "9/19", borderRadius: "32px" }}>
              ...
              <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-3 pt-2" style={{ zIndex: 2 }}>
                <span style={{ fontSize: "8px", color: "rgba(246,246,243,0.9)", fontFamily: "sans-serif", fontWeight: 600 }}>9:41</span>
                <span style={{ fontSize: "7px", color: "rgba(246,246,243,0.7)", fontFamily: "sans-serif" }}>FaceTime</span>
                <div className="flex items-center gap-1">
                  <div style={{ width: "10px", height: "6px", border: "1px solid rgba(246,246,243,0.7)", borderRadius: "1px", position: "relative" }}>
                    <div style={{ position: "absolute", left: "1px", top: "1px", bottom: "1px", width: "60%", background: "rgba(246,246,243,0.8)", borderRadius: "0.5px" }} />
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center gap-4 pb-4" style={{ background: "linear-gradient(to top, rgba(0,0,0,0.6) 0%, transparent 100%)", zIndex: 2, paddingTop: "24px" }}>
                <div className="flex items-center justify-center rounded-full" style={{ width: "28px", height: "28px", background: "rgba(246,246,243,0.2)" }}>
