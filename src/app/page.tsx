    ...
    <main>
      ...
      <section className="bg-cream overflow-hidden relative py-20 md:flex md:items-center" style={{ minHeight: "80vh" }}>
        ...
        <div className="pg-container relative">
          <div className="grid grid-cols-12 gap-8 items-center">
            ...
            <div className="col-span-12 md:col-span-5" data-aos="fade-right" data-aos-duration="1000">
              <div className="overflow-hidden" style={{ aspectRatio: "3/4", transform: "scale(1.05)", transformOrigin: "center center" }}>
                <img src="/assets/Yalda-17.avif" alt="Dr. Yalda Jamali" className="w-full h-full object-cover object-top" />
              </div>
            </div>

            {/* Right — introduction text */}
            <div className="col-span-12 md:col-span-5 md:col-start-8 flex flex-col gap-8" data-aos="fade-left" data-aos-delay="150" data-aos-duration="1000">
      ...
      <section className="bg-cream overflow-hidden relative py-20 md:flex md:items-center" style={{ minHeight: "80vh" }}>
        ...
        <div className="pg-container relative">
          <div className="grid grid-cols-12 gap-8 items-center">
            ...
            {/* Left — text */}
            <div className="col-span-12 md:col-span-5 flex flex-col gap-8" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div className="col-span-12 md:col-span-5 md:col-start-8" data-aos="fade-left" data-aos-delay="150" data-aos-duration="1000">
              <div className="overflow-hidden" style={{ aspectRatio: "3/4", transform: "scale(1.05)", transformOrigin: "center center" }}>
      ...
      >
        ...
        <blockquote className="relative z-10 pg-container w-full flex flex-col gap-8">
          <svg data-aos="fade-up" data-aos-duration="1000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-8 h-8" fill="rgba(244,241,238,0.3)" aria-hidden="true">
