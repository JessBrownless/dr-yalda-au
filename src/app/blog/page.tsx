...
export default function BlogIndexPage() {
  ...
  return (
    <main className="bg-parchment text-brand-black">
      ...
      {/* Masthead exception (Jessica): air below the subtitle mirrors the top padding */}
      <section className="pg-container pt-28 md:pt-40 pb-4 md:pb-6">
        ...
        <div
          className="mt-16 md:mt-24 pt-4 border-t border-brand-line flex items-baseline justify-between"
          data-aos="fade"
        >
