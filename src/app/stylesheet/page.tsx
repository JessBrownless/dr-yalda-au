...
const typeStyles: { className: string; label: string; specs: string; breakpoints: string; sample: string }[] = [
  ...
  { className: "heading-list",     label: ".heading-list — list-item name (flat)",      specs: "28px flat · leading 1.3 · +0.02em · sentence",      breakpoints: "Fixed 28px (all breakpoints)",     sample: "MSc Dermatology" },
  ...
  { className: "body-serif body-short", label: ".body-short — compact leading register",  specs: "modifier · leading 1.4 · compose with .body-serif/.body-sans", breakpoints: "After Carbon's body-short: 1-3 line bursts", sample: "Evidence-based cosmetic services across Sydney, delivered through consultation-led care." },
  { className: "body-serif body-long",  label: ".body-long — reading leading register",    specs: "modifier · leading 1.7 · the default for body classes",        breakpoints: "After Carbon's body-long: extended reading",  sample: "Evidence-based cosmetic services across Sydney, delivered through consultation-led care." },
