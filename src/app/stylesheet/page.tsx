...
const typeStyles: { className: string; label: string; specs: string; breakpoints: string; sample: string }[] = [
  ...
  { className: "footer-legal",     label: ".footer-legal — footer credit/copyright line", specs: "8px mobile · 10px md+ · +0.08em/+0.15em · uppercase", breakpoints: "8px < md · 10px ≥ md",           sample: "Made by North & Refine · Dr. Yalda Jamali · © 2026 All rights reserved" },
